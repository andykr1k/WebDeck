    ...
    return (
        <footer aria-label="Site Footer" class="bg-raisin">
            <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-lblue">
                ...
                <ul class="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                    ...
                    <li>
                    <a class="text-lblue transition hover:text-lblue/75" href="/team">
                        Team
                    </a>
                    </li>
                    ...
                    <li>
                    <a class="text-lblue transition hover:text-lblue/75" href="/terms">
                        Terms & Conditions
                    </a>
                    </li>
                    ...
                    <li>
                    <a class="text-lblue transition hover:text-lblue/75" href="/access">
                        Accessibility
                    </a>
                    </li>
                </ul>
